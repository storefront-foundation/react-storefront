...
exports.default = parseMultipartRequest;
 ...
 */
function parseMultipartRequest(body, contentType) {
  var s, fieldName; // Examples for content types:
  ...
  var parts = s.split(new RegExp(boundary)),
      partsByName = {}; // First part is a preamble, last part is closing '--'
...
//# sourceMappingURL=parseMultipartRequest.js.map