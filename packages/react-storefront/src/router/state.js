 ...
 * @return {Function}
 */
export default function state(handlerPath, getURL) {
  if (handlerPath == null) {
    throw new Error('You must provide a path to a handler in state().  Please check your routes.')
  }
